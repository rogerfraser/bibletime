...
public:
    ...
    /**
        * Pipes the given text with the specified format to Lyx.
        */
    virtual bool pipe( const CDisplay::TextType format, const CDisplay::TextPart part);
