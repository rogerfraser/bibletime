...
void CDisplayConnections::pipeAnchorWithText() {
    m_display->pipe(CDisplay::PlainText, CDisplay::AnchorWithText);
}
...
bool CDisplay::pipe( const CDisplay::TextType format, const CDisplay::TextPart part ) {
