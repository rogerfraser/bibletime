...
void CSearchResultView::initView() {
    ...
    BT_CONNECT(m_actions.pipeRefAndTextToLyX, SIGNAL(triggered()),
                this,                          SLOT(pipeItemsWithText()));
...
void CSearchResultView::pipeItemsWithText() {
    CExportManager mgr(true, tr("Piping search result"));
    ...
    mgr.pipeKeyList( keys, CExportManager::Text, true);
